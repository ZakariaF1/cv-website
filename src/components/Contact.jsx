      ...
      <div className="contact-grid">
        ...
        <div className="contact-right">
          <div className="contact-socials">
            <a href={`mailto:${profile.email}`} className="social-link primary">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <rect x="2" y="4" width="20" height="16" rx="2" />
                <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
              </svg>
              {profile.email}
              <svg className="social-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M5 12h14M12 5l7 7-7 7" />
              </svg>
            </a>
            <a href={profile.linkedinUrl} target="_blank" rel="noopener" className="social-link">
              <svg className="icon-linkedin" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href={profile.phoneHref} className="social-link">
              <svg className="icon-phone" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
